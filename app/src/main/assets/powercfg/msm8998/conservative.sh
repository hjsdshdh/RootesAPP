...
if [[ "$action" = "powersave" ]]; then
  ...
  interactive_cfg 0 0 9000 3000
  schedutil_cfg 0 1000 10000 0

  interactive_cfg 4 0 19000 5000
  ...
  interactive_cfg 0 0 9000 2000
  schedutil_cfg 0 1000 5000 0

  interactive_cfg 4 0 19000 3000
  ...
  interactive_cfg 0 79000 19000 2000
  schedutil_cfg 0 1000 1000 1

  interactive_cfg 4 79000 23000 3000
  ...
  interactive_cfg 4 79000 19000 2000
  schedutil_cfg 4 1000 1000 1
