...
if [[ "$action" = "powersave" ]]; then
  set_cpu_freq 300000 1612800 300000 1555200
  set_input_boost_freq 0 0 0
  set_hispeed_freq 1209600 806400
  sched_boost 0 0
  stune_top_app 0 0
  cpu0_core_ctl off
  cpu6_core_ctl on
  ...
  set_input_boost_freq 0 0 0
  set_hispeed_freq 1209600 1209600
  sched_boost 1 0
  stune_top_app 0 0
  cpu0_core_ctl off
  cpu6_core_ctl off
  ...
  set_input_boost_freq 1708800 1939200 120
